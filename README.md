...
GTFS files: – Sydney FAST2030 and Plan B: Better Buses for Sydney
...
Files not included due to size limitations include:

PBF files containing the OSM network for Greater Sydney
GTFS file of Existing Transport Network of Sydney
Employment and travel zone data. This can be accessed from:
...
leaflet – for mapping and visualisation
